...
import { deleteData, listTodos, save, ToDo   } from './data';
...
export const apiDeleteTodo = async (event : APIGatewayProxyEvent) : Promise<APIGatewayProxyResult> => {
    ...
    return {
        statusCode: 200,
        body: JSON.stringify(await deleteData(todo)),
    };
};
