...
describe('GetAPI', () => {
    ...
    it('should return list of todos', async () => {
        ...
        expect(list[0]).to.have.property('title', 'Todo text');
...
describe('AddAPI', () => {
    ...
    it('should save new todo', async () => {
        ...
        todoStub.save = (todoToSave : ToDo) => {
            ...
            expect(todoToSave).to.have.property('title', 'SomeText');
            expect(todoToSave).to.have.property('status', 'OPEN');
        ...
        expect(todo).to.have.property('title', 'SomeText');
